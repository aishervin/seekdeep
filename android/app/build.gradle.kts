...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 34
        val releaseVersionName = providers.gradleProperty("versionName").orElse("1.0.0").get()
        val releaseVersionCode = providers.gradleProperty("versionCode").orElse("10000").get().toInt()
